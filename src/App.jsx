...
const DATA = [
  { id:'princess-diana-bear', name:'Princess (Diana Bear)', img:'', category:'Bear', releaseYear:1997, peakYear:1998, peakPriceUSD:5000, currentPriceUSD:25, rarity:'Hype Icon',
    fun:["At peak, 'first edition' PVC pellets were hyped like royal treasure.","Charity + scarcity narrative supercharged the bubble."],
  ...
  { id:'peanut-royal-blue', name:'Peanut (Royal Blue)', img:'', category:'Elephant', releaseYear:1995, peakYear:1998, peakPriceUSD:3000, currentPriceUSD:40, rarity:'Color Variant',
    fun:["Early darker-blue run drove FOMO; lighter reissue diluted hype."],
