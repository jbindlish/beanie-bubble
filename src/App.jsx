      ...
      <div className="header">
        <div className="wrap">
          <div className="header-top">
            ...
            <div className="slogan">The world&apos;s online marketplace — late 1990s Jai Bindlish</div>
          </div>
        </div>
        <div className="nav">
              ...
              <div style={{display:'grid', gridTemplateColumns:'220px 1fr', gap:12}}>
                ...
                <div>
                  ...
                  <div style={{marginBottom:8}}>
                    Classic stuffed toy collectible from the late-1990s Beanie Baby fad. Visualize the price collapse from the 90s to now - crash of the speculative bubble.
                  </div>
